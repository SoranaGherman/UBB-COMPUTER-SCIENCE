...
class SortTest(unittest.TestCase):
    ...
    def comparison_greater(self, elem1, elem2):
        if elem1 < elem2:
            return True
        return False

    def comparison_smaller(self, elem1, elem2):
        if elem1 > elem2:
            return True
        return False
    ...
    def test_sorting_ascending(self):
        ...
        my_list = collection.comb_sort(my_list, self.comparison_greater)
        self.assertEqual(my_list, [2, 4, 6, 8, 9, 10])

    def test_sorting_descending(self):
        my_list = [6, 10, 4, 9, 2, 8]
        my_list = collection.comb_sort(my_list, self.comparison_smaller)
