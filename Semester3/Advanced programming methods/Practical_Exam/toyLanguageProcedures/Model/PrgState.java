...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stack, MyIStack<MyIDictionary<String, Value>> symTable, MyIList<Value> list, IFileTable
                    <String, BufferedReader> fileTable, IHeap heap, IProcTable procTable, IStmt originalProgram) {
        this.exeStack = stack;
