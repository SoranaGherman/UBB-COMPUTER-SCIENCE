...
public class programsList {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(),
                        new MyList<Value>(), new FileTable<String, BufferedReader>(), new Heap(),
                        selectedStatement);
                l1.add(prg1);
    ...
    private ObservableList<IStmt> getAllStatements() {
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("v", new IntType()),
                    new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(10))),
                    new CompStmt(new forkStmt(new CompStmt(new AssignStmt("v", new ArithExp("-", new VarExp("v"),
                            new ValueExp(new IntValue(1)))),
                            new CompStmt(new AssignStmt("v", new ArithExp("-", new VarExp("v"),
                                    new ValueExp(new IntValue(1)))),
                                    new PrintStmt(new VarExp("v"))))),
                            new CompStmt(new Sleep(10), new PrintStmt(new ArithExp("*", new VarExp("v"),
