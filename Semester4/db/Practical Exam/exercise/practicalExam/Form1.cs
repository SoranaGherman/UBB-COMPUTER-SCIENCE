...
namespace practicalExam
{
    public partial class Form1 : Form
    {
        ...
        void FillData()
        {
            ...
            ds.Relations.Add("producertoy", ds.Tables["Producer"].Columns["producerId"], ds.Tables["Toy"].Columns["producerId"]);
            ...
            bsChild = new BindingSource(bsParent, "producertoy"); // name of parent-child above
        ...
        {
            return "Data Source=DESKTOP-B77GF39;Initial Catalog=exercise;Integrated Security=true;";
        }
