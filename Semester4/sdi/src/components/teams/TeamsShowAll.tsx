...
export const TeamShowAll = () => {
    ...
    const fetchTeams = async () => {
        ...
        const response = await fetch(
          `${BACKEND_API_URL}/team/?page=${page}&page_size=${new_page_size}`
        );
    ...
    <Container>
        ...
        {!loading && (
            <IconButton id="add-team" component={Link} sx={{ mr: 3 }} to={`/teams/add`}>
                        ...
                        {teams.map((team:Team, index) => (
                            <TableRow key={team.id}>
                                ...
                                <TableCell align="center">
										...
										<IconButton id="delete-team" component={Link} sx={{ mr: 3 }} to={`/teams/${team.id}/delete`}>
